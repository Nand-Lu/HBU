...
def main():
    wandb.init(project="resnet", entity="nand_lu")
    wandb.config = {
        "learning_rate": 0.001,
        "epochs": 15,
        "batch_size": 4,
        "num_classes": 2,
        "input_size": 128,
        "pre_modelpath": r".\resnet50-19c8e357.pth",
    ...
    data_transform = {
            "train": transforms.Compose([# transforms.CenterCrop(224),单通道灰度图需要这行
                                         transforms.Resize((wandb.config["input_size"],wandb.config["input_size"])),#transforms.RandomResizedCrop(224),
                                         # Cutout(),
            ...
            "val": transforms.Compose([
                                       ...
                                       transforms.Resize((wandb.config["input_size"],wandb.config["input_size"])),
    ...
    nw = min([os.cpu_count(), wandb.config['batch_size'] if wandb.config['batch_size'] > 1 else 0, 8])
    ...
    pretrained_dict = torch.load(wandb.config["pre_modelpath"])
    ...
    optimizer = optim.Adam(params, lr= wandb.config['learning_rate'])
    ...
    for epoch in range( wandb.config['epochs']):
        ...
        for step, data in enumerate(train_bar):
            ...
            train_bar.desc = "train epoch[{}/{}] loss:{:.3f}".format(epoch + 1,
                                                                     wandb.config["epochs"],
                                                                     loss)
            wandb.log({"epoch1":epoch+1,"train loss": loss})
...
#................................log..................................................................
        log_save = open(r'.\log\log_CBAMG.txt', mode='a')
        ...
        wandb.log({"epoch":epoch+1,"train_loss": running_loss / train_steps,"val_accurate": val_accurate})
        wandb.watch(net)
    ...
    plt.figure(3)
    plt.plot(range(wandb.config["epochs"]) , lr_list, color='r')
    plt.savefig('lr.jpg')
   # print(best_acc is )
