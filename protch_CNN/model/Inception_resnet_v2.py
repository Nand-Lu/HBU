...
class Inception_ResNet_B(nn.Module):
    def __init__(self, input, scale=0.3):
        ...
        self.conv2 = conv1x1(in_planes =input,out_channels=128,stride=1, padding=0)
...
class Reduction_B(nn.Module):
    def __init__(self, input):
        ...
        self.conv4 = conv3x3(in_planes=256,  out_channels=288, stride=1, padding=1)
...
class Inception_ResNet_v2(nn.Module):
    def __init__(self, classes=2):
        ...
        for _ in range(10):
            blocks.append(Inception_ResNet_C(input=2048))
